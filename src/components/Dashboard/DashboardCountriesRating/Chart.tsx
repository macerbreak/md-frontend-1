...
const Chart:React.FC<{
  ...
  // const { data, error, isLoading } = useQuery<Data[]>("prices1", getPrices);
  const data = countryData1.map(countryDataItem=>[+countryDataItem[1]*1000,+countryDataItem[0]]) as Data[]
